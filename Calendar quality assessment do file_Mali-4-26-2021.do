...
* download the dataset for individual women's recode: "MLIR7AFL.DTA" 
...
cd "~/Analysis/Do Files/Mali"

* open the dataset to use, selecting just the variables we are going to use
use caseid vcal_1 v000 v005 v007 v008 v011 v018 v021 v023 using "MLIR7AFL.DTA", clear
 ...
 *Add months to the end of the calendar because the Mali most recent DHS (2013/14) does not overlap with the 2018 calandar. 
  foreach i in 73 74 75 76 77 78 79 80 81 82 83 84   {
...
**Insert cross sectional MCPR estimates manually for Mali 2018, and 2013-2014 for the specified age range (age 15-44)
gen DHS_mcpr = 15.88 if num==13
replace DHS_mcpr = 9.86 if num ==82
 
gen DHS_mcpr_ll =14.58 if num==13
replace DHS_mcpr_ll =  8.93 if num ==82

gen DHS_mcpr_ul = 17.27 if num==13
replace DHS_mcpr_ul =   10.88 if num ==82
...
graph twoway scatter  usingmodern_m_ num , ///
	...
	scheme(s2color) ///
	xlabel(21 "2018" 33 "2017" 45 "2016" 57 "2015" 69 "2014" 81 "2013" ) ///
	xtitle("Year") legend(r(2) order (1 "MCPR, DHS Calendar Estimate" 3  "MCPR, DHS 2018, 2013-2014" ))  ///
	graphregion(color(white)  )  ysize(10) xsize(10)  ///
	caption("Data: {it:DHS Mali}", size(*.7)) title("Calendar Quality Assessment, Mali")
