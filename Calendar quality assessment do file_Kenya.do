...
cd "~/Analysis/Do Files/Kenya"

* open the dataset to use, selecting just the variables we are going to use
use caseid vcal_1 v000 v005 v007 v008 v011 v018 v021 v023 using "KEIR71FL.DTA", clear
...
gen DHS_mcpr = 39.77 if num==16
replace DHS_mcpr = 28.07 if num ==75
...
graph twoway scatter  usingmodern_m_ num , ///
	...
	scheme(s2color) ///
	xlabel(16 "2014" 27 "2013" 39 "2012" 51 "2011" 63 "2010" 75 "2008/09") ///
	xtitle("Year") legend(r(2) order (1 "MCPR, DHS Calendar Estimate" 3  "MCPR, DHS 2014 & 2008/09" ))  ///
	graphregion(color(white)  )  ysize(10) xsize(10)  ///
	caption("Data: {it:DHS Kenya}", size(*.7)) title("Calendar Quality Assessment, Kenya")
