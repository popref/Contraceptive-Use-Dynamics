...
use caseid vcal_1 v000 v005 v007 v008 v011 v018 v021 v023 using "ZMIR61FL.DTA", clear
 ...
 *For zambia need to add 16 months to the graph to get to the prior DHS which was 6 years before instead of 5: 
 foreach i in 73 74 75 76 77 78 79 80 81 82 83 84 85 86 87 88 89 90 91 92 93 94 95 96 97  {
...
gen DHS_mcpr = 33.13 if num==13
replace DHS_mcpr = 25.06 if num==97
...
graph twoway scatter  usingmodern_m_ num , ///
	...
	scheme(s2color) ///
	xlabel(13 "2014" 25 "2013" 37 "2012" 49 "2011" 61 "2010" 73 "2009" 85 "2008" 97 "2007") ///
	xtitle("Year") legend(r(2) order (1 "MCPR, DHS Calendar Estimate" 3  "MCPR 2014, 2007" ))  ///
