...
cd "~/Analysis/Do Files/Malawi"

* open the dataset to use, selecting just the variables we are going to use
use caseid vcal_1 v000 v005 v007 v008 v011 v018 v021 v023 using "MWIR7HFL.DTA", clear
...
gen DHS_mcpr = 45.27 if num==11
replace DHS_mcpr = 32.60 if num ==70
...
graph twoway scatter  usingmodern_m_ num , ///
	...
	scheme(s2color) ///
	xlabel(11 "2015/16" 23 "2014/15" 35 "2013/14" 47 "2012/13" 59 "2011/12" 70 "2010/11") ///
	xtitle("Year") legend(r(2) order (1 "MCPR, DHS Calendar Estimate" 3  "MCPR, DHS 2010 & 2015/16" ))  ///
	graphregion(color(white)  )  ysize(10) xsize(10)  ///
	caption("Data: {it:DHS Malawi}", size(*.7)) title("Calendar Quality Assessment, Malawi")
